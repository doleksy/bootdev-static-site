...
class TestUtility(unittest.TestCase):
    ...
    def test_image(self):
        node = TextNode("This is an image node", TextType.IMAGE, "www.image.com/pict1.png")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props, {"src": "www.image.com/pict1.png", "alt": "This is an image node"})
